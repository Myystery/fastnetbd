    ...
    <div class="btn-group float-md-right" role="group">
        <div class="btn-group" role="group">
            <a class="btn btn-outline-blue-grey"
               modal-toggler="true" data-target="#remoteModal2" data-remote="<?= sysUrl('addArea') ?>">
                Add Area
            </a>
        </div>
    </div>
...
<script>
    ...
    function getTableData() {
        Table = $('.serverSide-table').DataTable({
            ...
            'aoColumns': [{mData: "areaName"}, {mData: "cityName"}, {mData: "eName"}, {mData: "areaAddedTime"}, {mData: "areaUpdatedTime"},
                {
                    mData: "actions",
                    bSortable: false
                }],
