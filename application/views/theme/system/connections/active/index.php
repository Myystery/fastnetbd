    ...
    <div class="btn-group float-md-right" role="group">
        <div class="btn-group" role="group">
            <a class="btn btn-outline-blue-grey"
               modal-toggler="true" data-target="#remoteModal2" data-remote="<?= sysUrl('addConnection') ?>">
                Add Connection
            </a>
        </div>
    </div>
...
<script>
    ...
    function getTableData() {
        Table = $('.serverSide-table').DataTable({
            ...
            'aoColumns': [{mData: "cusName"}, {mData: "pName"}, {mData: "conStart"},
                {mData: "conDetail"}, {mData: "eName"}, {mData: "conAddedTime"},
                {mData: "conUpdatedTime"}, {mData: "actions", bSortable: false}],
